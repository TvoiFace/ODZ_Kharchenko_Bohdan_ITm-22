...
class RatingDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding.hotelFormButton.setOnClickListener { onSubmitClicked() }
        binding.hotelFormCancel.setOnClickListener { onCancelClicked() }
    ...
    private fun onSubmitClicked() {
        ...
        user?.let {
            val rating = Rating(
                it,
                binding.hotelFormRating.rating.toDouble(),
                binding.hotelFormText.text.toString(),
            )
